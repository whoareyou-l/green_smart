...
def test_r7_100_version_surfaces_are_1_14_25():
    assert '"version": "1.14.32"' in _read(MANIFEST)
    assert 'const VERSION = "1.14.32"' in _read(LEGACY_PANEL)
    assert 'REBUILD_VERSION = "1.14.32"' in _read(REBUILD_PANEL)
...
def test_r7_100_greenhouse_info_rows_are_greenhouse_entities_when_db_has_multiple_greenhouses():
    html = _render("[\n        { id: 21, name: 'A동 온실', location: '화성 1농장', installType: '유리온실', approvalScope: '소유자 승인', status: 'active', note: '토마토 주력', updatedAt: '2026-07-02 11:00' },\n        { id: 22, name: 'B동 온실', location: '화성 2농장', installType: '비닐온실', approvalScope: '관리자 승인', status: 'active', note: '상추 실험', updatedAt: '2026-07-02 12:00' }\n      ]")
    ...
    assert '소유자 승인' in html and '관리자 승인' in html
...
def test_r7_100_detail_field_order_and_values_are_operator_schema():
    html = _render("[{ id: 31, name: 'C동 온실', location: '평택', installType: '연동형', approvalScope: '소유자 승인', status: 'active', note: '딸기', createdAt: '2026-07-01', updatedAt: '2026-07-02' }]")
    ordered = [
        'data-r7-cda-entity-detail-field="name"',
        'data-r7-cda-entity-detail-field="location"',
        'data-r7-cda-entity-detail-field="installType"',
        'data-r7-cda-entity-detail-field="approvalScope"',
    ...
    for value in ['C동 온실', '평택', '연동형', '소유자 승인', 'active', '2026-07-02', '2026-07-01', '딸기']:
