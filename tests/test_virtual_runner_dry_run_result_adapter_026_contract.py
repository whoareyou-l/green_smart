...
def test_docs_specs_plan_and_inventory_record_rs026_and_next_step():
    ...
    for marker in ("Phase R4.22 — Virtual runner dry-run result adapter", "Status:** `v1.15.50`에서 Virtual runner dry-run result adapter 완료", "No production route removal in RS-026", "No DB migration in RS-026", "No write/mutation in RS-026"):
