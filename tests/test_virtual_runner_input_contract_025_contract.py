...
def test_docs_specs_plan_and_inventory_record_rs025_and_next_step():
    ...
    for marker in ("Phase R4.21 — Virtual runner input contract", "Status:** `v1.15.10`에서 Virtual runner input contract 완료", "No production route removal in RS-025", "No DB migration in RS-025", "No write/mutation in RS-025"):
