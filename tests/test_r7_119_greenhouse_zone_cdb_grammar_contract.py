...
def test_r7_119_documented():
    doc = _read(DOC)
    for phrase in ('CDB card grammar hotfix in v1.15.39', 'summary row: 3 summary cards', 'action row: 2 two-button cards + 1 one-button equipment check card', 'list row: 1 list card'):
