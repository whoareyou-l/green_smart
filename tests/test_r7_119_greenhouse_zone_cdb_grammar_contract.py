...
def test_r7_119_documented():
    doc = _read(DOC)
    for phrase in ('CDB card grammar hotfix in v1.15.59', 'summary row: 3 summary cards', 'action row: 3 two-button cards including irrigation group create', 'list row: 1 list card'):
