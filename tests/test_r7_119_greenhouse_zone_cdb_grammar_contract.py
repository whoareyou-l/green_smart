...
def test_r7_119_version_surfaces_are_1_14_74():
...
def test_r7_119_documented():
    doc = _read(DOC)
    for phrase in ('CDB card grammar hotfix in v1.14.74', 'summary row: 3 summary cards', 'action row: 3 two-button cards', 'list row: 1 list card'):
