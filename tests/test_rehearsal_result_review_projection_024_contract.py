...
def test_docs_specs_plan_and_inventory_record_rs024_and_next_step():
    ...
    for marker in ("Phase R4.20 — Rehearsal result review projection", "Status:** `v1.14.40`에서 Rehearsal result review projection 완료", "No production route removal in RS-024", "No DB migration in RS-024", "No write/mutation in RS-024"):
