...
def test_v1986_all_crop_subtabs_use_summary_list_header_record_list_order():
    panel = _read(PANEL)
    sections = {
    ...
    required = {
        ...
        "ai": ("data-crop-ai-summary-card", "data-crop-ai-list-header", "data-crop-ai-evidence-list"),
