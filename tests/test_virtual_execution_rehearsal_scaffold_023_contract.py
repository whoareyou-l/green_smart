...
def test_docs_specs_plan_and_inventory_record_rs023_and_next_step():
    ...
    for marker in ("Phase R4.19 — Virtual execution rehearsal scaffold", "Status:** `v1.14.10`에서 Virtual execution rehearsal scaffold 완료", "No production route removal in RS-023", "No DB migration in RS-023", "No write/mutation in RS-023"):
