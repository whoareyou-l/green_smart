...
async def async_setup(hass, config):
    ...
    if schema_bootstrap:
        ...
        if not domain_data.get("_settings_views_registered"):
            ...
            hass.http.register_view(RebuildSettingsIrrigationGroupDeviceLinkView())
            ...
            hass.http.register_view(GreenSmartDevicesView())
            hass.http.register_view(GreenSmartDeviceItemView())
            hass.http.register_view(GreenSmartDeviceLatestDataView())
            hass.http.register_view(GreenSmartDeviceDataRefreshView())
            hass.http.register_view(GreenSmartDeviceSamplesView())
            ...
            hass.http.register_view(RebuildSettingsRolePermissionsView())
            hass.http.register_view(RebuildSettingsRolePermissionItemView())
