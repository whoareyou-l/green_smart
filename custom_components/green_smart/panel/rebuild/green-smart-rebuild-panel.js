...
class GreenSmartRebuildPanel extends HTMLElement {
  ...
  renderR7DomainVisualFrame({ domainKey, title, kicker, summary, status, tabs, activeTab, panels }) {
    return `<section data-r7-domain-visual-frame data-r7-domain-frame-width="safe-natural" data-r7-domain-visual-frame-version="1" data-r7-domain-visual-frame-domain="${domainKey}" data-r7-domain-frame-order="title-unified-card" data-r7-domain-previous-frame-order="title-subtabs-zone-content" data-r7-domain-top-env-metrics="removed" style="display:grid;gap:14px;min-width:0;">
