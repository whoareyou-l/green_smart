...
class GreenSmartRebuildPanel extends HTMLElement {
  ...
  renderR7SidebarUtilityGroup(referenceSlimRail) {
    ...
    const userInner = referenceSlimRail
      ...
      : `<span data-r7-sidebar-user-info data-r7-sidebar-user-text-align="right-near-logout" style="display:grid;gap:1px;min-width:0;text-align:right;justify-items:end;flex:1 1 auto;"><strong data-r7-sidebar-user-name style="font-size:12px;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%;">${userName}</strong><small data-r7-sidebar-user-role style="font-size:10px;line-height:1.2;color:#6f7f72;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%;">${userRole}</small></span><span data-r7-sidebar-user-avatar style="width:36px;height:36px;border-radius:999px;background:${R7_GREEN_ACCENT};color:#fff;display:inline-flex;align-items:center;justify-content:center;font-weight:1000;font-size:14px;flex:0 0 36px;">${userInitial}</span>`;
    ...
    const profileStyle = referenceSlimRail ? `${buttonStyle}position:relative;` : `min-height:54px;width:100%;border:0;border-radius:14px;background:#f7fbf8;color:${R7_GREEN_TEXT};display:grid;grid-template-columns:minmax(0,1fr) 36px;align-items:center;gap:8px;text-decoration:none;cursor:pointer;padding:0 8px;box-sizing:border-box;justify-items:end;`;
