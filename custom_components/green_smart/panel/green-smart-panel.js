// Green Smart — Modern SaaS greenhouse dashboard  v1.9.97
      ...
      <section data-crop-ai-main-card="crop-status" data-crop-ai-decision-summary data-crop-ai-primary-summary data-crop-ai-summary-stack style="background:#fff;border:1px solid #cfe8d8;border-radius:16px;padding:14px;margin-bottom:12px;box-shadow:0 6px 18px rgba(64,117,78,0.08);">
        ...
        <div data-crop-ai-main-card-body style="display:flex;flex-direction:column;gap:9px;">
          <div data-crop-ai-main-metric-grid data-crop-ai-primary-metric-grid style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px;">
            <div data-crop-ai-main-metric data-crop-ai-primary-gl-index style="background:#f8fbf9;border-radius:12px;padding:10px;border:1px solid #e2f1e7;"><div data-crop-ai-main-metric-label style="font-size:11px;color:#5f7f70;font-weight:900;">G/L-Index</div><b data-crop-ai-main-metric-value style="font-size:18px;color:#24323F;">${this._esc(String(latestG))}</b><div data-crop-ai-main-metric-help style="font-size:10px;color:#8aa091;margin-top:3px;">${gIndexTrend.length}개 point · 초장 ${heightTrend.length}개</div></div>
        ...
        <div data-crop-ai-main-card-chip-group style="font-size:10px;color:#9aae9d;margin-top:8px;line-height:1.45;">농장주/직원용 요약 우선 · read-only · 자동 실행 없음</div>
      </section>
  ...
  _renderEnvStrategyTabContent(s, modeOptions, aiStatusOptions, statusText) {
    ...
    if (tab === "overview") return `<section data-env-subtab-main-format data-env-subtab-summary-card data-env-status-card style="background:#fff;border:1px solid #dfeee1;border-radius:16px;padding:14px;margin-bottom:12px;box-shadow:0 6px 18px rgba(64,117,78,0.08);">
      ...
      <div data-env-status-metric-grid style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px;">
        ...
        <div data-env-status-metric style="background:#f8fbf9;border:1px solid #e2f1e7;border-radius:12px;padding:10px;"><span style="font-size:11px;color:#7a9780;">최종 목표</span><b style="display:block;color:#24323F;">${f.dayTargetTemp}°C / ${f.targetHumidity}%</b></div>
      </div>
