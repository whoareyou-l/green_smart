...
<article data-crop-ai-evidence-card="operator-workflow" data-crop-operator-workflow-card style="background:#fff;border-radius:12px;padding:10px;margin-bottom:10px;border:1px solid #dfeefe;">
  ...
  _renderEnvStrategyTabContent(s, modeOptions, aiStatusOptions, statusText) {
    ...
    if (tab === "overview") return `<section data-env-subtab-main-format data-env-subtab-summary-card data-env-status-card style="background:#fff;border:1px solid #dfeee1;border-radius:16px;padding:14px;margin-bottom:12px;box-shadow:0 6px 18px rgba(64,117,78,0.08);">
      ...
      <div data-env-status-note style="font-size:12px;color:#4a6741;margin-top:10px;line-height:1.55;">인터록 설정에서 PID 목표값과 인터록 기준을 함께 수정하고, 안전 설정에서 절대 한계와 센서 오류 대응을 별도로 관리합니다.</div>
