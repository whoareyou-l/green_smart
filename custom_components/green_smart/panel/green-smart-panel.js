// Green Smart — Modern SaaS greenhouse dashboard  v1.9.92
...
<div id="app">
  ...
  _renderGrowthReportCard() {
    ...
    return `<section class="gs-card" data-growth-report-card data-crop-ai-evidence-panel style="padding:14px;margin-bottom:14px;background:#fbfefb;border:1px solid #e3f1e5;">
      ...
      <section data-crop-ai-main-card="crop-status" data-crop-ai-decision-summary data-crop-ai-primary-summary data-crop-ai-summary-stack style="background:#fff;border:1px solid #cfe8d8;border-radius:16px;padding:14px;margin-bottom:12px;box-shadow:0 6px 18px rgba(64,117,78,0.08);">
        <div data-crop-ai-main-card-header data-crop-ai-section-heading style="display:flex;justify-content:space-between;gap:8px;align-items:flex-start;margin-bottom:10px;"><div><div style="font-size:15px;font-weight:900;color:#24323F;">작물 상태 요약</div><div style="font-size:11px;color:#7a9780;margin-top:3px;">이번 주 작물 판단 요약 · 가장 먼저 볼 핵심 작물 상태 지표입니다.</div></div><span style="font-size:10px;font-weight:900;border-radius:999px;padding:4px 9px;background:#f7fbff;color:#6d8799;border:1px solid #dbeaf8;">main</span></div>
        <div data-crop-ai-main-card-body data-crop-ai-primary-metric-grid style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px;">
        ...
        <div data-crop-ai-main-card-chip-group data-crop-ai-next-action style="background:#f8fbf9;border:1px solid #e2f1e7;border-radius:12px;padding:10px;margin-top:9px;font-size:12px;color:#4a6741;line-height:1.55;"><b>다음 행동</b> ${this._esc(aiNextAction)}</div>
      </section>
      <section data-crop-ai-main-card="interlock-status" data-crop-ai-interlock-summary data-crop-interlock-card style="background:#fff;border:1px solid ${cropInterlock.cropInterlockBlocked ? '#f3c8c8' : '#cfe8d8'};border-radius:16px;padding:14px;margin-bottom:12px;box-shadow:0 6px 18px rgba(64,117,78,0.08);">
        ...
        <div data-crop-ai-main-card-body data-crop-ai-interlock-grid style="display:grid;grid-template-columns:repeat(auto-fit,minmax(132px,1fr));gap:8px;">
      ...
      <section data-crop-ai-main-card="model-status" data-crop-ai-model-status-summary data-crop-ai-expanded-model-summary style="background:#fff;border:1px solid #cfe8d8;border-radius:16px;padding:14px;margin-bottom:12px;box-shadow:0 6px 18px rgba(64,117,78,0.08);">
        ...
        <div data-crop-ai-main-card-body data-crop-ai-model-status-grid style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px;">
