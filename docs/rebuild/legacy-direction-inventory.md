...
| Slice | Goal |
|---|---|
| RS-010 | Crop Cycle API naming boundary: compatibility routes vs new product DTO/API names |
| RS-011 | RBAC permission naming cleanup: map old permission labels to target permissions |
