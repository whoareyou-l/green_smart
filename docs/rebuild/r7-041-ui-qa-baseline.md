...
> Purpose: v1.14.48까지 만든 R7 화면/네비게이션/하위탭 UI를 실제 HA 브라우저와 render smoke로 QA하고, 하위탭 상세화/기능 연결 전 기준선을 잠근다.
...
release tag v1.14.48 exists
```


## v1.14.48 served JS note

served rebuild panel JS version: 1.14.48
