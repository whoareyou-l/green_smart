...
## CDB card grammar hotfix in v1.15.14
...
## Device/group DB-backed save in v1.15.14

The v1.15.14 slice converted `장치 추가` and `그룹 추가` from UI-only saved states to real DB/API writes.
