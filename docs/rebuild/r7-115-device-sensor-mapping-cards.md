...
## CDB card grammar hotfix in v1.15.19
...
## Device/group DB-backed save in v1.15.19

The v1.15.19 slice converted `장치 추가` and `그룹 추가` from UI-only saved states to real DB/API writes.
