...
v1.9.43 기준 관수 페이지는 초기 진입 시 여러 API 응답마다 전체 화면을 재렌더하지 않는다.
...
### 11.6 v1.9.43 생육 AI 전략/제어 페이지 정보 구조 contract

v1.9.43 기준 작물 관리와 제어 페이지는 다음 UI 구조를 유지한다.
...
### 11.7 v1.9.43 Admin/System 관리 기능 contract
