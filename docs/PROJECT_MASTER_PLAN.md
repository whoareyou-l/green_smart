...
- P1 rendered-flow QA v1.9.97: 현재 버전 기준 P1 smoke 계약은 유지하되, AI 전략은 모델 계층 구조로 검증하고 환경 제어 상태·기록형 탭은 별도 polish grammar로 검증한다.
