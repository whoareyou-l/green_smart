...
- P1 rendered-flow QA v1.9.84: Home → 작물 설정 → 병해충 예찰 → 방제 기록 실제 렌더 흐름에서 Home KPI 분리, pest/control 요약→액션→목록 순서, 병해충/방제 compact 모달, 금지 실행 marker 부재, console error 부재를 확인한다.
