# v1.15.32 모바일 설정 domain shell cache 계획
...
v1.15.32 목표는 **모바일 설정 도메인 한정**으로 domain page shell 자체를 persistent DOM cache에 보관하고, 설정 버튼 클릭 시 workspace 전체 innerHTML 교체 대신 cached shell attach/show를 사용하도록 바꾸는 것이다.
...
- 전체 테스트/Prod smoke/GitHub Release v1.15.32 완료.
