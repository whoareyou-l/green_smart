# v1.15.48 모바일 설정 버튼 freeze 및 도메인 탭 스크롤 보정 계획
...
- 운영 served 파일은 `/green_smart_panel/rebuild/green-smart-rebuild-panel.js?v=1.15.48`에서 v1.15.48이 정상 제공된다.
...
4. 검증
   ...
   - Prod served smoke에서 v1.15.48, settings dedicated action, active-only panels, right-edge scroll markers 확인.
