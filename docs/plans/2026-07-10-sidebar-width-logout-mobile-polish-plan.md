# v1.15.02 HA sidebar-aware width, logout, and mobile nav polish plan

## Problems

1. Admin accounts keep the Home Assistant sidebar visible. v1.15.02 root width still uses `100dvw`, so admin mode can become `HA sidebar + Green Smart 100dvw`, pushing domain pages to the right.
